...
<head>
    ...
    <title>Login - Rental Risk Analysis</title>
...
<div class="page-center">
    <div class="auth-box">
        <div class="auth-header">
            <h1><img src="/rental_risk/images/home.png" class="heading-icon" alt=""> Rental Risk Analysis</h1>
            <p>Sign in to continue to the screening system</p>
        </div>
        ...
        <div class="auth-footer">
            <p>Need an account? <a href="pages/register.php">Register as Tenant or Landlord</a></p>
